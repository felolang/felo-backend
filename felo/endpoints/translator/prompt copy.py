...
Steps:
1) translate "text" field from "source_language" to "target_language" to match "context". Please translate this as accurately as possible. So that the translation makes sense in the context
2) find additional phrases
...
5. "small_context": string - a smaller context (cropped) than in the "context" field. It is needed in order to accurately find the "text" in the context if it occurs more than once
OUTPUT
...
1. "extended_text": Optional[string] - if the "text" in "context" is a part of idiom, phrasal verb, slang, term etc extend it to the whole phrase. it CANT be shorter than the original text!
2. "text_translation": list[PossibleTranslation] - list of possible translations the "extended_text" to "target_language" in the "context". Only letters in the "target_language" are allowed.
...
5. "normalized_text_translation": list[PossibleTranslation] - list of possible translations of the field "normalized_text" in "context" and "small_context" to "target_language."


PossibleTranslation Model Fields:
  translation: string - try to translate as much as possible to the original context
