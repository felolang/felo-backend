...
# class FavoriteLookup(BaseTable):
#     __tablename__ = "favorite_lookup"
...
# class FavoriteLookupAnswer(BaseTable):
#     __tablename__ = "favorite_lookup_answer"
...
# class FavoriteLookupPhrases(BaseTable):
